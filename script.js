...
(function(){
  ...
  const sampleRestaurants = [
    {id:1, name:'Spice Route', rating:4.4, cuisine:'North Indian', price:'₹₹', img:'../assets/images/placeholder.svg', area:'HSR Layout'},
  ...
  on('#restaurants-list', ()=>{
    ...
    wrap.innerHTML = data.map(r=>`
      <a class="card" href="./restaurant-detail.html?id=${r.id}">
        <img class="thumb" src="../assets/images/spice.jpeg" alt="${r.name}"/>
        <div class="pad">
